...
eval(str_rot13('shapgvba purpx_sbbgre(){$y=\'<n uers="uggc://wbbzynegjbex.pbz" gnetrg="_oynax" gvgyr="wbbzyn grzcyngrf">Wbbzyn Grzcyngrf</n> ol WNJ, ivfvg JroUbfgvatGbc.bet sbe <n uers="uggc://jroubfgvatgbc.bet" gnetrg="_oynax" gvgyr="ubfgvat erivrjf">ubfgvat erivrjf</n>\';$s=qveanzr(__SVYR__).\'/vaqrk.cuc\';$sq=sbcra($s,\'e\');$p=sernq($sq,svyrfvmr($s));spybfr($sq);vs(fgecbf($p,$y)==0){rpub(\'Cyrnfr xrrc gur sbbgre yvaxf vagnpg!\');qvr;}}purpx_sbbgre();')); 
